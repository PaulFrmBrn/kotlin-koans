...
fun sendMessageToClient(
    ...
    val aClient=  client ?: return;
    val aMessage=  message ?: return;

    val email: String? = aClient.personalInfo?.email;

    if (email != null) mailer.sendMessage(email,aMessage) else return
}
